# Operator Quickstart — Wholesale of food, beverages and tobacco

Shortest path from clone to a verified local dry-run for **ISIC 4630** (`cloud-itonami-isic-4630`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4630.git
cd cloud-itonami-isic-4630
```
...
- Blueprint governor key: `provision-trading-governor`
- Likely source path: `provisiontrade.governor.cljc`
